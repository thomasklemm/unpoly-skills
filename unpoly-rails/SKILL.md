...
- **[patterns.md](references/patterns.md)** — End-to-end Rails patterns: drawer overlay helper, event-driven subinteractions (`up-accept-event`/`up-dismiss-event`), create related record inline + validate parent form
